...
import poly.cafe.ui.manager.ChangePasswordJDialog;
...
import poly.cafe.ui.manager.WelcomeJDialog;
import poly.cafe.util.XDialog;

/**
 * Interface quản lý các hành vi điều khiển chính của ứng dụng PolyCafe.
 * Bao gồm các phương thức hiển thị các hộp thoại và xử lý sự kiện thoát chương trình.
 * 
 * @author admin
 */
public interface PolyCafeController {
    ...
    /**
     * Khởi tạo giao diện chính của chương trình:
     * - Hiển thị cửa sổ chào
     * - Hiển thị cửa sổ đăng nhập
     * - Hiển thị thông tin user đăng nhập
     * - Bật/tắt các thành phần theo vai trò người dùng
     */
    void init();

    /**
     * Xác nhận và thoát ứng dụng
     */
    default void exit() {
